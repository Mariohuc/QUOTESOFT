...
public class CiaViewFestTest1{
    ...
    @Test
    public void checkInsertNewCiaCP08() {
        Conector.ChangeToTestMode();
        window.textBox("ciaructext").enterText("1645015602134");
        window.textBox("cianomtext").enterText("TechAqp S.A.");
        window.button("ciaguardarbutton").click();
        //window.optionPane().requireInformationMessage().requireMessage("Exito al guardar");
        window.label("stateCiaOperationLabel").requireText("¡Falló al guardar! Datos incorrectos");
