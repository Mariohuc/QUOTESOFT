...
public class TestSuc extends DatabaseTestCase {
    ...
    */
    ...
    protected IDataSet getDataSet() throws Exception{
      loadedDataSet = new FlatXmlDataSetBuilder().build(
              new FileInputStream(new File(this.getClass().getResource("/xml/suc.xml").getFile()))
      );
    ...
    public void testCheckCiasDataLoaded() throws Exception{
        ...
        int rowCount = loadedDataSet.getTable(TABLE_SUCURSALES).getRowCount();
    ...
    public void testCheckInsertOperation() throws Exception{
        ...
        PG_L13004_Mantenim_de_Suc sucDAO = new PG_L13004_Mantenim_de_Suc();
        sucDAO.agregarSucursal(2006, "Sucursal AQP", "A", 1002 );
        
        assertEquals(7, sucDAO.getNumerodeRegistros() );
        
        sucDAO.agregarSucursal( 2007, "Sucursal Qratos", "A", 1003 );
        assertEquals(7, sucDAO.getNumerodeRegistros() );
